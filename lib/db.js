...
const DEFAULT_SETTINGS = {
  ...
  // Email de confirmation automatique (envoyé quand present=true)
  event_start: '',
  event_end: '',
...
export async function ensureSchema() {
  ...
  await sql`ALTER TABLE benin_rsvp_settings ADD COLUMN IF NOT EXISTS event_start TEXT NOT NULL DEFAULT ''`;
  await sql`ALTER TABLE benin_rsvp_settings ADD COLUMN IF NOT EXISTS event_end TEXT NOT NULL DEFAULT ''`;
  await sql`ALTER TABLE benin_rsvp_settings ADD COLUMN IF NOT EXISTS email_subject TEXT NOT NULL DEFAULT ''`;
  await sql`ALTER TABLE benin_rsvp_settings ADD COLUMN IF NOT EXISTS email_body TEXT NOT NULL DEFAULT ''`;
  await sql`
