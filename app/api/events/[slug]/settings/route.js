...
import { getEventBySlug, getEventSettings, updateEventSettings } from '../../../../../lib/db';
...
export async function GET(req, { params }) {
  ...
  const payload = { ok: true, event, settings };
...
export async function PUT(req, { params }) {
  ...
  const settings = await updateEventSettings(event.id, partial);
